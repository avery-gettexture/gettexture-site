  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#FDF5ED', color: '#161612' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 48px 100px', fontFamily: 'var(--font-questrial), sans-serif', fontSize: '15px', lineHeight: 1.7, color: 'rgba(22,22,18,0.85)' }}>
        ...
        <p style={{ marginBottom: '12px' }}><strong>How do we process your information?</strong> We process your information to provide astrological interpretations. The birth location you type is sent to Google (Google Places) to provide autocomplete suggestions and determine your birthplace coordinates. Birth data is transmitted transiently to Vercel for chart calculation and to Anthropic for interpretation generation. Your personal data is stored in Supabase to enable permanent access to your reading.</p>
        ...
        <p style={{ marginBottom: '12px' }}><strong>Sensitive Information.</strong> We do not process special categories of personal data as defined under GDPR (such as data revealing health, religious beliefs, or biometric data). Your birth date, time, and location are processed solely to calculate your astrological chart and generate your reading.</p>
        <p style={{ marginBottom: '12px' }}><strong>Payment Data.</strong> All payment data is handled and stored by Stripe, Inc. and their payment processors. We do not have access to your full payment card details.</p>
        <p style={{ marginBottom: '32px' }}>All personal information that you provide to us must be true, complete, and accurate.</p>

        <H2>2. HOW DO WE PROCESS YOUR INFORMATION?</H2>
        <p style={{ marginBottom: '12px' }}>We process your personal information to deliver and facilitate delivery of astrological interpretation services to you. The birth location text you enter is sent to Google Places to provide autocomplete suggestions and determine your birthplace coordinates, used solely to calculate your chart. Birth date, time, and location are transmitted to Vercel for chart calculation and to Anthropic for interpretation generation. Your name, birth data, and email are stored in our database to enable permanent access to your reading and to deliver your reading URL.</p>
        <p style={{ marginBottom: '32px' }}><strong>Marketing communications.</strong> We send transactional emails necessary to deliver your reading (such as your reading link). We send marketing or product-update emails only to individuals who have opted in to receive them — for example, by asking to be notified when a new feature becomes available. You can withdraw this consent at any time using the unsubscribe link in any such email or by contacting <a href="mailto:help@gettexture.app" style={{ color: 'rgba(185,18,18,0.75)' }}>help@gettexture.app</a>. In jurisdictions that require express consent for commercial electronic messages (such as Canada under CASL or the EU/UK under GDPR and PECR), we rely on your opt-in as the basis for sending these messages.</p>
        ...
        <p style={{ marginBottom: '12px' }}><em><strong>If you are located in the EU or UK:</strong></em> The GDPR requires us to explain the valid legal bases we rely on. We rely on Performance of a Contract as our primary legal basis. We may also rely on Legal Obligations where required by law. Where we send you marketing or product-update communications, our legal basis is your consent, which you may withdraw at any time.</p>
        ...
        <ul style={{ margin: '12px 0 16px 24px' }}>
          ...
          <li style={{ marginBottom: '8px' }}><strong>Third-Party Service Providers.</strong> We share birth data transiently with Vercel for chart calculation and with Anthropic for interpretation generation. We share the birth location you type with Google (Google Places) to determine your birthplace coordinates. Your reading data is stored in Supabase. Payment information is processed by Stripe. See Section 14 for full details.</li>
        </ul>
        ...
        <p style={{ marginBottom: '32px' }}>Yes. Texture's core service uses AI to generate personalized astrological interpretations. We provide AI products through Anthropic as our AI Service Provider. Chart data (planetary positions and placements, not personal birth data) is shared with Anthropic to generate interpretations. We do not send your name or email address to Anthropic with this request. Anthropic processes this data under its own commercial terms, does not use it to train its models, and may retain it for a limited period in accordance with its data-retention and trust-and-safety policies.</p>

        <H2>6. HOW LONG DO WE KEEP YOUR INFORMATION?</H2>
        <p style={{ marginBottom: '32px' }}>Your personal data — name, birth data, email, and generated reading content — is stored in our database indefinitely so that you can access your reading at any time via your permanent URL. You may request deletion of your data at any time by contacting us at <a href="mailto:help@gettexture.app" style={{ color: 'rgba(185,18,18,0.75)' }}>help@gettexture.app</a>. We will delete your record within 30 days of receiving your request. Birth data transmitted to Vercel for chart calculation is not retained by Vercel. Birth location text sent to Google for location lookup is processed under Google's own privacy policy — see Section 14. Chart data transmitted to Anthropic for interpretation generation may be retained by Anthropic for a limited period under its own data-retention and trust-and-safety policies — see Section 5.</p>
