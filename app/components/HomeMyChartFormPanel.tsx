...
export default function HomeMyChartFormPanel() {
  return (
    <div style={{ position: 'absolute', inset: 0, background: 'var(--cream)', display: 'flex', flexDirection: 'column', padding: '4% 6%' }}>
      <div style={{ fontFamily: 'var(--font-anton), sans-serif', fontSize: 'clamp(21px, 2.2vw, 28px)', color: DARK, letterSpacing: '1px', marginBottom: '8px' }}>
        My Chart
      </div>
      <p style={{ fontFamily: 'var(--font-questrial), sans-serif', fontSize: 'clamp(11px, 0.9vw, 12px)', color: DARK_MUTED, lineHeight: 1.5, marginBottom: '2.5%' }}>
      ...
      <div style={{ borderTop: '1px solid var(--red-rule)', paddingTop: '2.5%' }}>
