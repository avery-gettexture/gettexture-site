...
export async function generateTransitPiece(focusBody, reading, readingSlug) {
  const { text: engineText, counts, meta, entryIds } = await assembleBrief(focusBody, { reading });
  ...
  const { synthesisProse, timelineEntries } = parseCall2Output(call2.text, entryIds);
